    ...
    <section id='skills'>
      <div className='container px-5 py-10 mx-auto'>
        <div className='text-center mb-20'>
          ...
          <h1 className='sm:text-4xl text-3xl font-medium title-font text-balck mb-4'>Skills &amp; Technologies</h1>
          <p className='text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto'>
            I'm skilled in <strong>Bash, Powershell, Command Line</strong> and am advancing my knowledge in Object-Oriented-Programming.
          </p>
        </div>
